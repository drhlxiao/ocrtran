...
class MainWindow(QMainWindow):
    def __init__(self, args):
        ...
        # Replace "icon.png" with the actual path to your icon file
        icon = QIcon(abspath("icons/capture.png"))
    ...
    def text_updated_translate(self):
        self.source_text_changed_timer.start(1000)
